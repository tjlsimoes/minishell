...
#    Updated: 2025/03/03 18:13:45 by asafrono         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell
CC = cc
CFLAGS = -Wall -Wextra -I$(LIBFT_DIR) -I$(SRC_DIR)
DEBUG_FLAGS = -g
RM = rm -rf
...
executor_builtins_a.c executor_gen.c executor_main.c executor_path_res_abs_path.c \
